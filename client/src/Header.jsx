  ...
  return (
    <div>
      <header className="flex justify-between">
        ...
        <div className="flex items-center border gap-2 border-gray-300 rounded-full px-4 py-2 shadow-md shadow-gray-300">
        ...
        <Link to={'/login'} className="flex items-center border gap-2 border-gray-300 rounded-full px-4 py-2">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
